...
public class GSTiling {
	...
	public static PlagResult run(String s1, String s2, int mML, float threshold) {
		...
		System.out.println("\nFirst Position --  Second Position -- Number of Similar Word");
	...
	private static int createKRHashValue(String substring) {
		...
		//System.out.println("\t"+substring.charAt(i)+":"+(int) substring.charAt(i));
			}
		//System.out.println("\nHashValue : " + hashValue);
		return hashValue;
	}
	 ...
	 * return None dist is also number of unmarked token 'tile next tile
	 * 
	 * @param p
	 * @param p2
